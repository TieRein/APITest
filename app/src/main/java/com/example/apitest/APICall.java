...
public class APICall {
    ...
    public static JSONObject runDevice(int device, int duration) throws JSONException {
        String commandDeviceAPI = "https://mys6g529gb.execute-api.us-west-2.amazonaws.com/commandDeviceStage";
        JSONObject request = new JSONObject();
        request.put("topic", "Quick_Run");
        request.put("device", device);
        request.put("duration", duration);

        return makeCall(commandDeviceAPI, request);
    }
